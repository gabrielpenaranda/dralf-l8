...
<div class="container">
    ...
    <div class="columns is-mobile">
        <div class="column is-8 is-offset-2">
            <br>
            <h3 class="title is-4 has-text-centered">Reporte de Ventas desde {{ $desde }} hasta
                {{ $hasta }}</h3>
        </div>
    </div>
    ...
    <div class="columns is-mobile">
        <div class="column is-offset-6 is-6">
            <br>
            <span class="title is-4 has-text-centered">Total IVA Cobrado
                {{ number_format($acumulador_iva, 2, ',', '.') }}</span>
        </div>
    </div>
</div>
