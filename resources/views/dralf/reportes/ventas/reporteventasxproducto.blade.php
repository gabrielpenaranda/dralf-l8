...
<div class="container">
    ...
    <div class="columns is-mobile">
        <div class="column is-6 is-offset-3">
            <br>
            <h3 class="title is-4 has-text-centered">Reporte de Ventas</h3>
            <br>
        </div>
    </div>

    <form action="{{ route('reportes.generareporteventasxproducto') }}" method="POST">
        ...
        <div class="columns is-mobile">
            ...
            <div class="column is-4">
                <div class="field">
                    <div class="control">
                        <label for="producto" class="is-size-7 has-text-weight-bold">Producto:
                        </label> <br>
                        <select name="producto" class="is-size-7">
